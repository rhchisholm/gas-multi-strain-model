% Generates Figure 3E-F, S4A-B and S9E-F in Chisholm et al., Unravelling the immune response to Group 
% A Streptococcus infection from population-level observations of 
...
for w = 1 : 3
    ...
    if w == 1 
        load('mat_files/figure3E.mat');
    elseif w == 2
        load('mat_files/figureS4A.mat');
    else
        load('mat_files/figureS9E.mat');
    end
    ...
    if w == 1
        savefig('figure_files/figure3E.fig')
        saveas(gcf,'figure_files/figure3E','epsc')
    elseif w == 2
        savefig('figure_files/figureS4A.fig')
        saveas(gcf,'figure_files/figureS4A','epsc')
    else
        savefig('figure_files/figureS9E.fig')
        saveas(gcf,'figure_files/figureS9E','epsc')

    end   
end


% Varying N figures: 3F, S4B, S9F
...
for w = 1 : 3
    ...
    %%%%%%%%%%%%%
        if w == 1
            if di == 1
                load('mat_files/figure3F_1.mat');
            elseif di ==2
                load('mat_files/figure3F_2.mat');
            elseif di == 3
                load('mat_files/figure3F_3.mat');
            else
                load('mat_files/figure3F_4.mat');
            end
        elseif w == 2
            if di == 1
            ...
            if di == 1
                load('mat_files/figureS9F_1.mat');
            elseif di ==2
                load('mat_files/figureS9F_2.mat');
            elseif di == 3
                load('mat_files/figureS9F_3.mat');
            else
                load('mat_files/figureS9F_4.mat');
            end
        end
    ...
    if w == 1
        savefig('figure_files/figure3F.fig')
        saveas(gcf,'figure_files/figure3F','epsc')
    elseif w ==2
        savefig('figure_files/figureS4B.fig')
        saveas(gcf,'figure_files/figureS4B','epsc')
    else
        savefig('figure_files/figureS9F.fig')
        saveas(gcf,'figure_files/figureS9F','epsc')
    end
