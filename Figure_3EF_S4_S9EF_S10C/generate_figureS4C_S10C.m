% Generates Figure S4C and S10C in Chisholm et al., Unravelling the immune 
% response to Group A Streptococcus infection from population-level 
...
for CIScenario = 1:2
    ...
    if CIScenario == 1
        ...
        savefig('figure_files/figureS10C.fig')
        saveas(gcf,'figure_files/figureS10C','epsc')
    end
end
