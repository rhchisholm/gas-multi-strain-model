% Generates Figure 3A-D, S2, S3, S9A-D, and S10A-B in Chisholm et al., 
% Unravelling the immune response to Group A Streptococcus infection from 
% population-level observations of prevalence and strain diversity
...
% Scenario w = 1:2 : figure3A-D
% Scenario w = 3:4 : figure S2
% Scenario w = 5:6 : figure S9A-D


for w = 1 : 6
    
    if w == 1
        load('mat_files/figure3_AB.mat');
    elseif w == 2
        load('mat_files/figure3_CD.mat');
    elseif w == 3       
        load('mat_files/figureS2_AB.mat');
    elseif w == 4
        load('mat_files/figureS2_CD.mat');
    elseif w == 5
        load('mat_files/figureS9_AB.mat');
    else
        load('mat_files/figureS9_CD.mat');
    end
    ...
    if w == 1
        savefig('figure_files/figure3_A.fig')
        saveas(gcf,'figure_files/figure3_A','epsc')
    elseif w == 2
        savefig('figure_files/figure3_C.fig')
        saveas(gcf,'figure_files/figure3_C','epsc')
    elseif w == 3
    ...
    elseif w == 5
        savefig('figure_files/figureS9_A.fig')
        saveas(gcf,'figure_files/figureS9_A','epsc')
    else
        savefig('figure_files/figureS9_C.fig')
        saveas(gcf,'figure_files/figureS9_C','epsc')
    end
    ...
    if w == 1
        savefig('figure_files/figure3_B.fig')
        saveas(gcf,'figure_files/figure3_B','epsc')
    elseif w == 2
        savefig('figure_files/figure3_D.fig')
        saveas(gcf,'figure_files/figure3_D','epsc')
    elseif w == 3
    ...
    elseif w == 5
        savefig('figure_files/figureS9_B.fig')
        saveas(gcf,'figure_files/figureS9_B','epsc')
    else
        savefig('figure_files/figureS9_D.fig')
        saveas(gcf,'figure_files/figureS9_D','epsc')
    end
...
for w = 1 : 4
    ...
    elseif w == 3
        ...
        load('mat_files/figureS10_AB.mat');
    end
    ...
    elseif w == 3
        ...
        load('mat_files/figureS10_CD.mat');
    end
    ...
    elseif w == 3
        savefig('figure_files/figureS10_A.fig')
        saveas(gcf,'figure_files/figureS10_A','epsc')
    else
        savefig('figure_files/figureS10_B.fig')
        saveas(gcf,'figure_files/figureS10_B','epsc')
    end
