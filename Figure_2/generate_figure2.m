% Generates Figure 2 in Chisholm et al., Unravelling the within-host 
...
if ~exist('figure2_figure_files', 'dir')
    mkdir('figure2_figure_files')
end
...
for w = 1 : 3
    ...
    load(sprintf('figure2_mat_files/figure2_%s.mat',l(w,:)))
    ...
    savefig(sprintf('figure2_figure_files/figure2_%s.fig',l(w,1)))
    saveas(gcf,sprintf('figure2_figure_files/figure2_%s',l(w,1)),'epsc')
    ...
    savefig(sprintf('figure2_figure_files/figure2_%s.fig',l(w,2)))
    saveas(gcf,sprintf('figure2_figure_files/figure2_%s',l(w,2)),'epsc')
    ...
    savefig(sprintf('figure2_figure_files/figure2_%s.fig',l(w,3)))
    saveas(gcf,sprintf('figure2_figure_files/figure2_%s',l(w,3)),'epsc')
