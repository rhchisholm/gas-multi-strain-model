...
% Figure 2 in Chisholm et al., Unravelling the within-host 
% dynamics of Group A Streptococcus from population-level observations of 
% prevalence and strain diversity

   
% Transmission scenarios: 
% Scenario 1: Figure 2 panels A-C, 
% Scenario 2: Figure 2 panels D-F,
% Scenario 3: Figure 2 panels G-I.
...
if ~exist('figure2_mat_files', 'dir')
    mkdir('figure2_mat_files')
end
...
for Scenario = 1 : 3
    ...
    if Scenario == 1
        save('figure2_mat_files/figure2_ABC.mat');
    elseif Scenario == 2
        save('figure2_mat_files/figure2_DEF.mat');
    else
        save('figure2_mat_files/figure2_GHI.mat');
    end
