...
save_gm_name='GM_DI5_15_'+str(n_m)
#save_gm_name='GM_DI15_25_'+str(n_m)
np.savez(save_gm_name,global_marginal=global_marginal)

# OR load global marginal data
#save_gm_name='GM_DI5_15_320.npz'
#save_gm_name='GM_DI15_25_320.npz'
...
# Real data:
y_obs = np.array([[6.4949, 6.0202,13.0000,5.4762,11.0000,21.0000,11.5762,30.8923,2.7273,5.5411,-0.4385]])
...
for k in np.arange(bolfire.n_initial_evidence, max_evidence + step_size, step_size):
    ...
    save_model_name1='FIT_DI5_15_'+str(k)
    save_model_name2='PARAMS_DI5_15_'+str(k) 
    #save_model_name1='FIT_DI15_25_'+str(k)
    #save_model_name2='PARAMS_DI15_25_'+str(k)   
...
save_model_name3='SAMPLES_DI5_15_'+str(num_iterations)
#save_model_name3='SAMPLES_DI15_25_'+str(num_iterations)
