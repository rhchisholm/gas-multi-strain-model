% Generates Figure S8 in Chisholm et al., Unravelling the immune response 
...
for w = 1 : 3
    ...
    load(sprintf('mat_files/figureS8_%s.mat',l(w,:)))
    ...
    savefig(sprintf('figure_files/figureS8_%s.fig',l(w,1)))
    saveas(gcf,sprintf('figure_files/figureS8_%s',l(w,1)),'epsc')
    ...
    savefig(sprintf('figure_files/figureS8_%s.fig',l(w,2)))
    saveas(gcf,sprintf('figure_files/figureS8_%s',l(w,2)),'epsc')
    ...
    savefig(sprintf('figure_files/figureS8_%s.fig',l(w,3)))
    saveas(gcf,sprintf('figure_files/figureS8_%s',l(w,3)),'epsc')
