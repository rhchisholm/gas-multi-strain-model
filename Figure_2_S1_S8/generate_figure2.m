% Generates Figure 2 in Chisholm et al., Unravelling the immune response to Group A 
...
for w = 1 : 3
    ...
    load(sprintf('mat_files/figure2_%s.mat',l(w,:)))
    ...
    savefig(sprintf('figure_files/figure2_%s.fig',l(w,1)))
    saveas(gcf,sprintf('figure_files/figure2_%s',l(w,1)),'epsc')
    ...
    savefig(sprintf('figure_files/figure2_%s.fig',l(w,2)))
    saveas(gcf,sprintf('figure_files/figure2_%s',l(w,2)),'epsc')
    ...
    savefig(sprintf('figure_files/figure2_%s.fig',l(w,3)))
    saveas(gcf,sprintf('figure_files/figure2_%s',l(w,3)),'epsc')
