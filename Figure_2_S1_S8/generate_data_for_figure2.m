...
% Figure 2 in Chisholm et al., Unravelling the immune response to Group A 
...
for Scenario = 1 : 3
    ...
    if Scenario == 1
        save('mat_files/figure2_ABC.mat');
    elseif Scenario == 2
        save('mat_files/figure2_DEF.mat');
    else
        save('mat_files/figure2_GHI.mat');
    end
