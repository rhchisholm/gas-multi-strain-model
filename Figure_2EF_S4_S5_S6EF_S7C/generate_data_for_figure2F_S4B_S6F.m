% Produces mat files that are used in generate_figure2EF_S4AB_S6EF.m to 
% generate Figures 2F, S4B and S6F
...
% rtc 1: data for Figure 2F
% rtc 2: data for Figure S4B
% rtc 3: data for Figure S6F
        ...
        for i = 1 : length(delta)
            ...
            for j = 1 : length(N)
                ...
                if rtc == 1
                    ...
                    if Scenario == 1
                        save('mat_files/figure2F_1.mat');
                    elseif Scenario == 2
                        save('mat_files/figure2F_2.mat');
                    elseif Scenario ==3
                        save('mat_files/figure2F_3.mat');
                    else
                        save('mat_files/figure2F_4.mat');
                    end
                ...
                elseif rtc == 2
                    ...
                    if Scenario == 1
                        save('mat_files/figureS6F_1.mat');
                    elseif Scenario == 2
                        save('mat_files/figureS6F_2.mat');
                    elseif Scenario ==3
                        save('mat_files/figureS6F_3.mat');
                    else
                        save('mat_files/figureS6F_4.mat');
                    end
