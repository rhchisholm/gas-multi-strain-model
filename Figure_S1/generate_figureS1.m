% Generates Figure S1 in Chisholm et al., Unravelling the within-host 
...
if ~exist('figureS1_figure_files', 'dir')
    mkdir('figureS1_figure_files')
end
...
for w = 1 : 3
    ...
    load(sprintf('figureS1_mat_files/figureS1_%s.mat',l(w,:)))
   ...
   % Plot number of infections of each strain as function of time
    ...
    savefig(sprintf('figureS1_figure_files/figureS1_%s.fig',l(w,1)))
    saveas(gcf,sprintf('figureS1_figure_files/figureS1_%s',l(w,1)),'epsc')
    ...
    savefig(sprintf('figureS1_figure_files/figureS1_%s.fig',l(w,2)))
    saveas(gcf,sprintf('figureS1_figure_files/figureS1_%s',l(w,2)),'epsc')
    ...
    savefig(sprintf('figureS1_figure_files/figureS1_%s.fig',l(w,3)))
    saveas(gcf,sprintf('figureS1_figure_files/figureS1_%s',l(w,3)),'epsc')
